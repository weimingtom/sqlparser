...
//    main.testCompare();
  ...
  public void testSegment(){
    String[] segmentArr = new String[]{"求和 (AI_94传票对照表.省/市代号)", "(AI_94传票对照表.金额 加 AI_94传票对照表.货币码) 乘 AI_94传票对照月表.金额"};
  ...
  public void testTranslator() {
    ...
    str = "查询 AI_94传票对照表.省/市代号 作为 省/市代号, 测试.行号 作为 行号, 求和(AI_94传票对照表.金额) 作为 金额 " +
          "来自 AI_94传票对照表 作为 测试 条件 AI_94传票对照表.省/市代号 等于 '0200' " +
          "分组 AI_94传票对照表.省/市代号,AI_94传票对照表.行号 排序 求和(AI_94传票对照表.金额) 升序, AI_94传票对照表.行号 降序";
    str = "查询 AI_94传票对照表.省/市代号 作为 省/市代号 , AI_94传票对照表.行号 作为 行号 , 求和(AI_94传票对照表.金额) 作为 金额  来自 AI_94传票对照表 条件 AI_94传票对照表.省/市代号 等于 '0200' 分组 AI_94传票对照表.省/市代号, AI_94传票对照表.行号 排序 求和(AI_94传票对照表.金额) 升序, AI_94传票对照表.行号 降序";
//    str = "表合并 表1, 表2";
    Translator t = new Translator();
    t.setChQuery(str);
    System.out.println(t.getChQuery());
...
//    System.out.println(t.getChOrderByStr());
    ...
    try{
      ...
      AppDbTable[] appDbTables = t.getInfo().getDbTableInfoToAppTableArr();
