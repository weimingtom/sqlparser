...
public T() {
	...
	public final FunctionModel  function(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			default:
				if (_t==null) _t=ASTNULL;
				if (((_t.getType() >= LITERAL_sum && _t.getType() <= LITERAL_vsize))) {
