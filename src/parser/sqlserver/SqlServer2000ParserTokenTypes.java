...
public interface SqlServer2000ParserTokenTypes {
	int EOF = 1;
	...
	int LITERAL_ntile = 308;
	int LITERAL_percentile_count = 309;
	int LITERAL_percentile_desc = 310;
	int LITERAL_argn = 311;
	// "\u53d6\u7b2cn\u4e2a\u53d8\u91cf" = 312
	int LITERAL_coalesce = 313;
	// "\u53d6\u9996\u4e2a\u975e\u7a7a\u53d8\u91cf1" = 314
	int LITERAL_ifnull = 315;
	// "\u7a7a\u53d8\u91cf\u7f6e\u6362" = 316
	int LITERAL_isnull = 317;
	// "\u53d6\u9996\u4e2a\u975e\u7a7a\u53d8\u91cf2" = 318
	int LITERAL_nullif = 319;
	// "\u5224\u65ad\u53d8\u91cf\u662f\u5426\u76f8\u7b49" = 320
	int TILDE = 321;
	// "\u975e\u8fd0\u7b97" = 322
	// "\u4e0e" = 323
	...
	int NOTEQUAL1 = 345;
	int NOTEQUAL2 = 346;
	int LESSTHANOREQUALTO1 = 347;
	int LESSTHANOREQUALTO2 = 348;
	int LESSTHAN = 349;
	int GREATERTHANOREQUALTO1 = 350;
	int GREATERTHANOREQUALTO2 = 351;
	int GREATERTHAN = 352;
	int LITERAL_yy = 353;
	int LITERAL_mm = 354;
	int LITERAL_dd = 355;
	int LITERAL_qq = 356;
	int LITERAL_week = 357;
	int LITERAL_wk = 358;
	int LITERAL_dayofyear = 359;
	int LITERAL_dy = 360;
	int LITERAL_weekday = 361;
	int LITERAL_dw = 362;
	int LITERAL_hh = 363;
	int LITERAL_mi = 364;
	int LITERAL_ss = 365;
	int LITERAL_millisecond = 366;
	int LITERAL_ms = 367;
	int LITERAL_calweekofyear = 368;
	int LITERAL_cwk = 369;
	int LITERAL_calyearofweek = 370;
	int LITERAL_cyr = 371;
	int LITERAL_caldayofweek = 372;
	int LITERAL_cdw = 373;
	int LITERAL_uniqueidentifierstr = 374;
	int LITERAL_bigint = 375;
	int LITERAL_int = 376;
	int LITERAL_integer = 377;
	int LITERAL_smallint = 378;
	int LITERAL_tinyint = 379;
	int LITERAL_double = 380;
	int LITERAL_real = 381;
	int LITERAL_smalldatetime = 382;
	int LITERAL_time = 383;
	int LITERAL_timestamp = 384;
	int LITERAL_bit = 385;
	int DOT_STAR = 386;
	int PARAM_LPAREN = 387;
	int PARAM_RPAREN = 388;
	int FROM = 389;
	int WS = 390;
	int ESC = 391;
	int ID_START_LETTER = 392;
	int ID_LETTER = 393;
	int NUM = 394;
	int DOT_NUM = 395;
	int NUM_START = 396;
