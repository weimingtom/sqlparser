// $ANTLR 2.7.7 (2006-11-01): "src/parser/sqlserver/parser_sqlserver.g" -> "SqlServer2000Lexer.java"$
...
public class SqlServer2000Lexer extends antlr.CharScanner implements SqlServer2000ParserTokenTypes, TokenStream
 {
public SqlServer2000Lexer(InputStream in) {
	this(new ByteBuffer(in));
}
public SqlServer2000Lexer(Reader in) {
	this(new CharBuffer(in));
}
public SqlServer2000Lexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public SqlServer2000Lexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("dd", this), new Integer(355));
	literals.put(new ANTLRHashString("ifnull", this), new Integer(315));
	...
	literals.put(new ANTLRHashString("weekday", this), new Integer(361));
	literals.put(new ANTLRHashString("number", this), new Integer(130));
	literals.put(new ANTLRHashString("\u6c42\u5177\u4f53\u5206\u949f", this), new Integer(271));
	literals.put(new ANTLRHashString("argn", this), new Integer(311));
	...
	literals.put(new ANTLRHashString("week", this), new Integer(357));
	literals.put(new ANTLRHashString("\u6216\u8005", this), new Integer(66));
	literals.put(new ANTLRHashString("smallint", this), new Integer(378));
	...
	literals.put(new ANTLRHashString("\u4e58", this), new Integer(328));
	literals.put(new ANTLRHashString("cyr", this), new Integer(371));
	...
	literals.put(new ANTLRHashString("ms", this), new Integer(367));
	literals.put(new ANTLRHashString("\u52a0", this), new Integer(326));
	...
	literals.put(new ANTLRHashString("\u53d6\u9996\u4e2a\u975e\u7a7a\u53d8\u91cf2", this), new Integer(318));
	...
	literals.put(new ANTLRHashString("time", this), new Integer(383));
	...
	literals.put(new ANTLRHashString("rowid", this), new Integer(402));
	...
	literals.put(new ANTLRHashString("integer", this), new Integer(377));
	literals.put(new ANTLRHashString("dy", this), new Integer(360));
	literals.put(new ANTLRHashString("as", this), new Integer(69));
	literals.put(new ANTLRHashString("isnull", this), new Integer(317));
	literals.put(new ANTLRHashString("nullif", this), new Integer(319));
	literals.put(new ANTLRHashString("convert", this), new Integer(132));
	literals.put(new ANTLRHashString("desc", this), new Integer(77));
	literals.put(new ANTLRHashString("\u53d6\u9996\u4e2a\u975e\u7a7a\u53d8\u91cf1", this), new Integer(314));
	...
	literals.put(new ANTLRHashString("dayofyear", this), new Integer(359));
	...
	literals.put(new ANTLRHashString("cdw", this), new Integer(373));
	literals.put(new ANTLRHashString("\u6c42\u4f59\u5207\u503c", this), new Integer(151));
	literals.put(new ANTLRHashString("dw", this), new Integer(362));
	...
	literals.put(new ANTLRHashString("bigint", this), new Integer(375));
	...
	literals.put(new ANTLRHashString("millisecond", this), new Integer(366));
	literals.put(new ANTLRHashString("\u5c0f\u4e8e\u7b49\u4e8e", this), new Integer(339));
	literals.put(new ANTLRHashString("percentile_desc", this), new Integer(310));
	literals.put(new ANTLRHashString("\u51cf", this), new Integer(327));
	...
	literals.put(new ANTLRHashString("\u975e\u8fd0\u7b97", this), new Integer(322));
	...
	literals.put(new ANTLRHashString("\u5927\u4e8e\u7b49\u4e8e", this), new Integer(338));
	...
	literals.put(new ANTLRHashString("ntile", this), new Integer(308));
	...
	literals.put(new ANTLRHashString("mm", this), new Integer(354));
	...
	literals.put(new ANTLRHashString("caldayofweek", this), new Integer(372));
	literals.put(new ANTLRHashString("calweekofyear", this), new Integer(368));
	literals.put(new ANTLRHashString("quarter", this), new Integer(278));
	literals.put(new ANTLRHashString("tinyint", this), new Integer(379));
	literals.put(new ANTLRHashString("\u6c42\u79d2\u6570", this), new Integer(281));
	literals.put(new ANTLRHashString("real", this), new Integer(381));
	literals.put(new ANTLRHashString("calyearofweek", this), new Integer(370));
	...
	literals.put(new ANTLRHashString("percentile_count", this), new Integer(309));
	...
	literals.put(new ANTLRHashString("\u5de6\u8fde\u63a5", this), new Integer(343));
	...
	literals.put(new ANTLRHashString("\u6c42\u884c\u53f7", this), new Integer(403));
	...
	literals.put(new ANTLRHashString("\u53d6\u7b2cn\u4e2a\u53d8\u91cf", this), new Integer(312));
	...
	literals.put(new ANTLRHashString("mi", this), new Integer(364));
	...
	literals.put(new ANTLRHashString("\u4e0e", this), new Integer(323));
	...
	literals.put(new ANTLRHashString("ss", this), new Integer(365));
	...
	literals.put(new ANTLRHashString("timestamp", this), new Integer(384));
	...
	literals.put(new ANTLRHashString("uniqueidentifierstr", this), new Integer(374));
	...
	literals.put(new ANTLRHashString("\u5224\u65ad\u53d8\u91cf\u662f\u5426\u76f8\u7b49", this), new Integer(320));
	...
	literals.put(new ANTLRHashString("int", this), new Integer(376));
	...
	literals.put(new ANTLRHashString("\u7a7a\u53d8\u91cf\u7f6e\u6362", this), new Integer(316));
	...
	literals.put(new ANTLRHashString("hh", this), new Integer(363));
	...
	literals.put(new ANTLRHashString("yy", this), new Integer(353));
	...
	literals.put(new ANTLRHashString("\u5927\u4e8e", this), new Integer(340));
	...
	literals.put(new ANTLRHashString("\u4e0d\u7b49\u4e8e", this), new Integer(342));
	literals.put(new ANTLRHashString("cwk", this), new Integer(369));
	...
	literals.put(new ANTLRHashString("wk", this), new Integer(358));
	...
	literals.put(new ANTLRHashString("bit", this), new Integer(385));
	literals.put(new ANTLRHashString("double", this), new Integer(380));
	...
	literals.put(new ANTLRHashString("smalldatetime", this), new Integer(382));
	literals.put(new ANTLRHashString("\u5de6\u622a\u5b57\u7b26\u4e32", this), new Integer(201));
	literals.put(new ANTLRHashString("\u6216", this), new Integer(324));
	...
	literals.put(new ANTLRHashString("\u5f02\u6216", this), new Integer(325));
	...
	literals.put(new ANTLRHashString("\u5c0f\u4e8e", this), new Integer(341));
