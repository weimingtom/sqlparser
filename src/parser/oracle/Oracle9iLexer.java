...
public Oracle9iLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("upper", this), new Integer(209));
	literals.put(new ANTLRHashString("\u4e8c\u8fdb\u5236\u8f6c\u4e3a\u6570\u503c", this), new Integer(222));
	literals.put(new ANTLRHashString("t_union", this), new Integer(37));
	literals.put(new ANTLRHashString("ranslate", this), new Integer(207));
	...
	literals.put(new ANTLRHashString("dd", this), new Integer(302));
	literals.put(new ANTLRHashString("\u6c42\u4e32\u4f4d\u7f6e", this), new Integer(174));
	literals.put(new ANTLRHashString("least", this), new Integer(261));
	literals.put(new ANTLRHashString("bfile", this), new Integer(333));
	literals.put(new ANTLRHashString("nls_lower", this), new Integer(189));
	...
	literals.put(new ANTLRHashString("weekday", this), new Integer(313));
	literals.put(new ANTLRHashString("new_time", this), new Integer(217));
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32ASCII\u7801", this), new Integer(166));
	literals.put(new ANTLRHashString("hh12", this), new Integer(317));
	literals.put(new ANTLRHashString("count", this), new Integer(91));
	literals.put(new ANTLRHashString("tan", this), new Integer(157));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u65e5\u671f\u578b", this), new Integer(236));
	literals.put(new ANTLRHashString("day", this), new Integer(301));
	literals.put(new ANTLRHashString("\u6c42\u6b63\u5f26\u503c", this), new Integer(152));
	literals.put(new ANTLRHashString("week", this), new Integer(307));
	...
	literals.put(new ANTLRHashString("\u6c42\u5b57\u6bb5\u5927\u5c0f", this), new Integer(250));
	literals.put(new ANTLRHashString("trunc", this), new Integer(161));
	literals.put(new ANTLRHashString("\u6c42\u6700\u5c0f\u8868\u8fbe\u5f0f", this), new Integer(262));
	literals.put(new ANTLRHashString("\u4e58", this), new Integer(272));
	literals.put(new ANTLRHashString("\u8fd4\u56de\u6570\u636e\u683c\u5f0f", this), new Integer(254));
	literals.put(new ANTLRHashString("\u6c42ASCII\u7801", this), new Integer(164));
	literals.put(new ANTLRHashString("ms", this), new Integer(326));
	literals.put(new ANTLRHashString("\u52a0", this), new Integer(270));
	literals.put(new ANTLRHashString("\u5728\u4e8e", this), new Integer(86));
	literals.put(new ANTLRHashString("\u6c42\u603b\u548c", this), new Integer(112));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u5de6\u8865", this), new Integer(186));
	...
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u591a\u5b57\u8282\u578b", this), new Integer(238));
	literals.put(new ANTLRHashString("\u53d6\u4e0a\u9650\u6574\u6570", this), new Integer(130));
	literals.put(new ANTLRHashString("to_single_byte", this), new Integer(241));
	literals.put(new ANTLRHashString("rowid", this), new Integer(329));
	literals.put(new ANTLRHashString("length", this), new Integer(177));
	literals.put(new ANTLRHashString("and", this), new Integer(60));
	literals.put(new ANTLRHashString("\u6708\u4efd\u8fd0\u7b97", this), new Integer(212));
	literals.put(new ANTLRHashString("user", this), new Integer(245));
	literals.put(new ANTLRHashString("dy", this), new Integer(311));
	literals.put(new ANTLRHashString("\u6c42\u6700\u5927\u8868\u8fbe\u5f0f", this), new Integer(260));
	literals.put(new ANTLRHashString("as", this), new Integer(66));
	literals.put(new ANTLRHashString("\u6c42\u5bf9\u6570", this), new Integer(142));
	literals.put(new ANTLRHashString("convert", this), new Integer(225));
	literals.put(new ANTLRHashString("nls_initcap", this), new Integer(187));
	literals.put(new ANTLRHashString("desc", this), new Integer(74));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5b57\u7b26\u578b", this), new Integer(234));
	literals.put(new ANTLRHashString("\u6c42\u65e5\u671f\u6700\u540e\u4e00\u5929", this), new Integer(214));
	literals.put(new ANTLRHashString("\u6c42\u53cd\u6b63\u5f26\u503c", this), new Integer(124));
	literals.put(new ANTLRHashString("exists", this), new Integer(44));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u53f3\u8865", this), new Integer(198));
	literals.put(new ANTLRHashString("qq", this), new Integer(305));
	literals.put(new ANTLRHashString("like", this), new Integer(76));
	literals.put(new ANTLRHashString("date", this), new Integer(328));
	literals.put(new ANTLRHashString("\u9664", this), new Integer(273));
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32\u6700\u5927\u503c", this), new Integer(352));
	literals.put(new ANTLRHashString("variance", this), new Integer(113));
	literals.put(new ANTLRHashString("hextoraw", this), new Integer(227));
	literals.put(new ANTLRHashString("dayofyear", this), new Integer(310));
	...
	literals.put(new ANTLRHashString("dw", this), new Integer(314));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u8f6c\u4e3a\u884c\u53f7", this), new Integer(224));
	literals.put(new ANTLRHashString("nlssort", this), new Integer(191));
	literals.put(new ANTLRHashString("instrb", this), new Integer(175));
	literals.put(new ANTLRHashString("trim", this), new Integer(205));
	literals.put(new ANTLRHashString("between", this), new Integer(84));
	literals.put(new ANTLRHashString("millisecond", this), new Integer(325));
	literals.put(new ANTLRHashString("\u5c0f\u4e8e\u7b49\u4e8e", this), new Integer(283));
	literals.put(new ANTLRHashString("\u4e8c\u8fdb\u5236\u8f6c\u4e3a\u5341\u516d\u8fdb\u5236", this), new Integer(230));
	literals.put(new ANTLRHashString("substr", this), new Integer(203));
	literals.put(new ANTLRHashString("\u51cf", this), new Integer(271));
	literals.put(new ANTLRHashString("\u6c42\u6807\u8bc6\u7f16\u53f7", this), new Integer(244));
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32\u58f0\u97f3\u503c", this), new Integer(202));
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32\u6700\u5c0f\u503c", this), new Integer(353));
	literals.put(new ANTLRHashString("\u683c\u5f0f\u5316\u6570\u503c2", this), new Integer(162));
	literals.put(new ANTLRHashString("to_multi_byte", this), new Integer(237));
	literals.put(new ANTLRHashString("empty_clob", this), new Integer(257));
	literals.put(new ANTLRHashString("d", this), new Integer(303));
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32\u957f\u5ea6", this), new Integer(178));
	literals.put(new ANTLRHashString("\u975e\u8fd0\u7b97", this), new Integer(266));
	literals.put(new ANTLRHashString("t_compare", this), new Integer(40));
	literals.put(new ANTLRHashString("long", this), new Integer(327));
	literals.put(new ANTLRHashString("\u6c42\u6b63\u5207\u503c", this), new Integer(158));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5927\u5199\u5b57\u6bcd2", this), new Integer(194));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u6392\u5e8f", this), new Integer(192));
	literals.put(new ANTLRHashString("\u6c42\u53cc\u66f2\u6b63\u5f26\u503c", this), new Integer(154));
	literals.put(new ANTLRHashString("not", this), new Integer(47));
	literals.put(new ANTLRHashString("\u5927\u4e8e\u7b49\u4e8e", this), new Integer(282));
	...
	literals.put(new ANTLRHashString("rawtohex", this), new Integer(229));
	literals.put(new ANTLRHashString("\u53bb\u5de6\u53f3\u7a7a\u683c", this), new Integer(206));
	literals.put(new ANTLRHashString("lengthb", this), new Integer(179));
	literals.put(new ANTLRHashString("\u53d6\u5f53\u524d\u65e5\u671f\u65f6\u95f4", this), new Integer(116));
	literals.put(new ANTLRHashString("nclob", this), new Integer(331));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5927\u5199\u5b57\u6bcd1", this), new Integer(210));
	literals.put(new ANTLRHashString("sign", this), new Integer(149));
	literals.put(new ANTLRHashString("\u6c42\u6a21", this), new Integer(144));
	literals.put(new ANTLRHashString("empty_blob", this), new Integer(255));
	literals.put(new ANTLRHashString("mm", this), new Integer(299));
	literals.put(new ANTLRHashString("\u5168\u90e8", this), new Integer(94));
	literals.put(new ANTLRHashString("\u8868\u5408\u5e76", this), new Integer(38));
	literals.put(new ANTLRHashString("hour", this), new Integer(315));
	literals.put(new ANTLRHashString("\u53bb\u6389\u5de6\u7a7a\u683c", this), new Integer(184));
	literals.put(new ANTLRHashString("\u6c42\u5e42\u503c", this), new Integer(136));
	literals.put(new ANTLRHashString("\u53d6\u4e0b\u9650\u6574\u6570", this), new Integer(138));
	literals.put(new ANTLRHashString("quarter", this), new Integer(304));
	literals.put(new ANTLRHashString("clob", this), new Integer(330));
	literals.put(new ANTLRHashString("ceil", this), new Integer(129));
	literals.put(new ANTLRHashString("add_months", this), new Integer(211));
	literals.put(new ANTLRHashString("chr", this), new Integer(167));
	literals.put(new ANTLRHashString("to_char", this), new Integer(233));
	...
	literals.put(new ANTLRHashString("\u5de6\u8fde\u63a5", this), new Integer(351));
	literals.put(new ANTLRHashString("\u5e76\u4e14", this), new Integer(62));
	literals.put(new ANTLRHashString("lower", this), new Integer(181));
	literals.put(new ANTLRHashString("y", this), new Integer(312));
	literals.put(new ANTLRHashString("\u4f5c\u4e3a", this), new Integer(67));
	literals.put(new ANTLRHashString("asciistr", this), new Integer(165));
	literals.put(new ANTLRHashString("\u6c42\u5f53\u524d\u7528\u6237\u73af\u5883\u4fe1\u606f", this), new Integer(248));
	literals.put(new ANTLRHashString("rpad", this), new Integer(197));
	literals.put(new ANTLRHashString("\u53bb\u6389\u53f3\u7a7a\u683c", this), new Integer(200));
	literals.put(new ANTLRHashString("blob", this), new Integer(332));
	...
	literals.put(new ANTLRHashString("ltrim", this), new Integer(183));
	literals.put(new ANTLRHashString("yyyy", this), new Integer(297));
	...
	literals.put(new ANTLRHashString("w", this), new Integer(309));
	literals.put(new ANTLRHashString("log", this), new Integer(141));
	literals.put(new ANTLRHashString("stddev", this), new Integer(109));
	literals.put(new ANTLRHashString("mi", this), new Integer(320));
	literals.put(new ANTLRHashString("\u67e5\u8be2", this), new Integer(49));
	literals.put(new ANTLRHashString("max", this), new Integer(105));
	literals.put(new ANTLRHashString("bin_to_num", this), new Integer(221));
	literals.put(new ANTLRHashString("\u5b57\u8282\u65b9\u5f0f\u6c42\u4e32\u4f4d\u7f6e", this), new Integer(176));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5355\u5b57\u8282\u578b", this), new Integer(242));
	literals.put(new ANTLRHashString("\u975e\u7a7a", this), new Integer(82));
	literals.put(new ANTLRHashString("nls_upper", this), new Integer(193));
	literals.put(new ANTLRHashString("\u4e0e", this), new Integer(267));
	...
	literals.put(new ANTLRHashString("soundex", this), new Integer(201));
	literals.put(new ANTLRHashString("uid", this), new Integer(243));
	literals.put(new ANTLRHashString("\u6c42\u6708\u4efd\u5dee\u503c", this), new Integer(216));
	literals.put(new ANTLRHashString("\u6c42\u5e73\u5747\u6570", this), new Integer(104));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u8f6c\u5316", this), new Integer(226));
	literals.put(new ANTLRHashString("rowidtochar", this), new Integer(231));
	literals.put(new ANTLRHashString("ss", this), new Integer(323));
	...
	literals.put(new ANTLRHashString("rtrim", this), new Integer(199));
	...
	literals.put(new ANTLRHashString("year", this), new Integer(295));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u622a\u53d6", this), new Integer(204));
	literals.put(new ANTLRHashString("chartorowid", this), new Integer(223));
	literals.put(new ANTLRHashString("decode", this), new Integer(251));
	literals.put(new ANTLRHashString("s", this), new Integer(324));
	...
	literals.put(new ANTLRHashString("dump", this), new Integer(253));
	literals.put(new ANTLRHashString("hh24", this), new Integer(318));
	literals.put(new ANTLRHashString("months_between", this), new Integer(215));
	literals.put(new ANTLRHashString("replace", this), new Integer(195));
	literals.put(new ANTLRHashString("\u6c42\u5f53\u524d\u7528\u6237", this), new Integer(246));
	literals.put(new ANTLRHashString("vsize", this), new Integer(249));
	literals.put(new ANTLRHashString("\u6c42\u81ea\u7136\u5bf9\u6570", this), new Integer(140));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u5168\u66ff\u6362", this), new Integer(208));
	literals.put(new ANTLRHashString("greatest", this), new Integer(259));
	literals.put(new ANTLRHashString("\u521d\u59cb\u5316CLOB", this), new Integer(258));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u6570\u503c\u578b", this), new Integer(240));
	literals.put(new ANTLRHashString("\u6c42\u5bf9\u5e94\u65f6\u533a\u7684\u65f6\u95f4", this), new Integer(218));
	...
	literals.put(new ANTLRHashString("q", this), new Integer(306));
	literals.put(new ANTLRHashString("exp", this), new Integer(135));
	literals.put(new ANTLRHashString("\u6c42\u5177\u4f53\u661f\u671f\u7684\u65e5\u671f", this), new Integer(220));
	...
	literals.put(new ANTLRHashString("\u521d\u59cb\u5316BLOB", this), new Integer(256));
	literals.put(new ANTLRHashString("mod", this), new Integer(143));
	literals.put(new ANTLRHashString("\u6761\u4ef6", this), new Integer(43));
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5c0f\u5199\u5b57\u6bcd2", this), new Integer(190));
	literals.put(new ANTLRHashString("minute", this), new Integer(319));
	literals.put(new ANTLRHashString("sinh", this), new Integer(153));
	literals.put(new ANTLRHashString("hh", this), new Integer(316));
	literals.put(new ANTLRHashString("next_day", this), new Integer(219));
	literals.put(new ANTLRHashString("cancat", this), new Integer(169));
	literals.put(new ANTLRHashString("\u6c42\u4e8c\u4e2a\u6570\u7684\u53cd\u6b63\u5207\u503c", this), new Integer(128));
	literals.put(new ANTLRHashString("yy", this), new Integer(296));
	...
	literals.put(new ANTLRHashString("\u8f6c\u4e3a\u5c0f\u5199\u5b57\u6bcd1", this), new Integer(182));
	literals.put(new ANTLRHashString("\u4e0d\u5728\u4e8e", this), new Integer(87));
	literals.put(new ANTLRHashString("=", this), new Integer(68));
	literals.put(new ANTLRHashString("nvl", this), new Integer(263));
	...
	literals.put(new ANTLRHashString("lpad", this), new Integer(185));
	literals.put(new ANTLRHashString("n", this), new Integer(321));
	literals.put(new ANTLRHashString("to_number", this), new Integer(239));
	literals.put(new ANTLRHashString("\u5927\u4e8e", this), new Integer(284));
	literals.put(new ANTLRHashString("\u6c42\u6bd4\u8f83\u7ed3\u679c", this), new Integer(252));
	literals.put(new ANTLRHashString("ascii", this), new Integer(163));
	literals.put(new ANTLRHashString("\u4e0d\u7b49\u4e8e", this), new Integer(286));
	...
	literals.put(new ANTLRHashString("\u5341\u516d\u8fdb\u5236\u8f6c\u4e3a\u4e8c\u8fdb\u5236", this), new Integer(228));
	literals.put(new ANTLRHashString("\u6c42\u975e\u7a7a\u503c", this), new Integer(264));
	literals.put(new ANTLRHashString("\u5355\u8bcd\u9996\u5b57\u6bcd\u5927\u51992", this), new Integer(188));
	literals.put(new ANTLRHashString("userenv", this), new Integer(247));
	literals.put(new ANTLRHashString("\u6216", this), new Integer(268));
	literals.put(new ANTLRHashString("to_date", this), new Integer(235));
	literals.put(new ANTLRHashString("\u4e3a", this), new Integer(95));
	literals.put(new ANTLRHashString("\u884c\u53f7\u8f6c\u6210\u5b57\u7b26\u4e32", this), new Integer(232));
	literals.put(new ANTLRHashString("last_day", this), new Integer(213));
	literals.put(new ANTLRHashString("\u5f02\u6216", this), new Integer(269));
	literals.put(new ANTLRHashString("\u5c0f\u4e8e", this), new Integer(285));
}
