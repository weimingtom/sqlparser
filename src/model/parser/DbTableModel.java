...
//    }
  ...
  public String[] getTablesNameArr(){
    ...
    for (int i = 0; i < tablesLi.size(); i++){
      ...
      tablesNameArr[i] = _tableVO.cnTableName;
    }
  ...
  public String[] getFieldsNameArrByTableName(String tableChName){
    ...
    for (int i = 0; i < tablesLi.size(); i++){
      ...
      if (_tableVO.cnTableName.equals(tableChName)){
        List li = _tableVO.fieldsLi;
        fieldsNameArr = new String[li.size()];
        for (int j = 0; j < li.size(); j++){
          FieldVO _fieldVO = (FieldVO) li.get(j);
          fieldsNameArr[j] = _fieldVO.chFieldName;
        }
      }
    }
