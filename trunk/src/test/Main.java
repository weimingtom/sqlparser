...
//	    System.out.println("TO DB XML: " + xml);
  ...
  public void customQueryTest(){
  	String[] strArr = new String[]{
  			...
  			"查询 将数据类型转化为(bigint, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(int, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(integer, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(smallint, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(tinyint, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(decimal(10), AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(decimal(10, 2), AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(numeric(10), AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(numeric(10, 2), AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(double, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(float(12), AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(real, AI_94传票对照表.金额) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(binary(200), AI_94传票对照表.内容) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(varbinary(200), AI_94传票对照表.内容) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(date, '2007-01-01') 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(datetime, '2007-01-01') 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(smalldatetime, '2007-01-01') 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(time, '2007-01-01') 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(timestamp, '2007-01-01') 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 将数据类型转化为(bit, AI_94传票对照表.标识) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 数据类型转化(AI_94传票对照表.日期 as date) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 数据类型转化(字符串截取(AI_94传票对照表.省/市代号, 1, 4) as char(5)) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  			
  			"查询 数据类型转化(AI_94传票对照表.日期 as NUMERIC(18, 2)) 作为 省/市代号 来自 AI_94传票对照表 作为 CNF" +
  			" 条件 AI_94传票对照表.省/市代号 等于 '1'",
  		};
