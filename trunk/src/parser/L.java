...
public L(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("\u6c42\u56db\u820d\u540e\u7684\u6574\u6570", this), new Integer(91));
	...
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u53f3\u622a", this), new Integer(83));
	literals.put(new ANTLRHashString("between", this), new Integer(58));
	literals.put(new ANTLRHashString("\u53bb\u6389\u53f3\u7a7a\u683c", this), new Integer(87));
	literals.put(new ANTLRHashString("\u6392\u5e8f", this), new Integer(35));
	literals.put(new ANTLRHashString("substring", this), new Integer(78));
	...
	literals.put(new ANTLRHashString("\u6c42\u7edd\u5bf9\u503c", this), new Integer(77));
	...
	literals.put(new ANTLRHashString("getdate", this), new Integer(74));
	literals.put(new ANTLRHashString("where", this), new Integer(23));
	literals.put(new ANTLRHashString("\u6c42\u8bb0\u5f55\u6570", this), new Integer(109));
	...
	literals.put(new ANTLRHashString("rtrim", this), new Integer(86));
	...
	literals.put(new ANTLRHashString("\u6c42\u5b57\u7b26\u4e32\u7684\u957f\u5ea6", this), new Integer(89));
	literals.put(new ANTLRHashString("\u552f\u4e00", this), new Integer(28));
	literals.put(new ANTLRHashString("floor", this), new Integer(90));
	...
	literals.put(new ANTLRHashString("count", this), new Integer(108));
	literals.put(new ANTLRHashString("sqrt", this), new Integer(72));
	literals.put(new ANTLRHashString("like", this), new Integer(122));
	literals.put(new ANTLRHashString("\u5e76\u4e14", this), new Integer(40));
	literals.put(new ANTLRHashString("char_length", this), new Integer(88));
	literals.put(new ANTLRHashString("\u6c42\u6700\u5c0f\u503c", this), new Integer(107));
	literals.put(new ANTLRHashString("\u6c42\u6a21", this), new Integer(120));
	literals.put(new ANTLRHashString("charindex", this), new Integer(96));
	literals.put(new ANTLRHashString("\u683c\u5f0f\u5316\u6570\u503c", this), new Integer(81));
	literals.put(new ANTLRHashString("\u6c42\u4e94\u5165\u540e\u7684\u6574\u6570", this), new Integer(93));
	literals.put(new ANTLRHashString("\u6216", this), new Integer(114));
	literals.put(new ANTLRHashString("round", this), new Integer(80));
	literals.put(new ANTLRHashString("\u5b57\u7b26\u4e32\u622a\u53d6", this), new Integer(79));
	literals.put(new ANTLRHashString("\u6c42\u5e73\u65b9\u6839", this), new Integer(73));
	...
	literals.put(new ANTLRHashString("\u6c42\u5f53\u524d\u65e5\u671f\u65f6\u95f4", this), new Integer(75));
	literals.put(new ANTLRHashString("ceiling", this), new Integer(92));
	literals.put(new ANTLRHashString("\u5c06\u5b57\u7b26\u4e32\u8f6c\u4e3a\u5c0f\u5199", this), new Integer(95));
	literals.put(new ANTLRHashString("\u6570\u503c\u8f6c\u5b57\u7b26\u4e32", this), new Integer(99));
	...
	literals.put(new ANTLRHashString("ltrim", this), new Integer(84));
	...
	literals.put(new ANTLRHashString("lower", this), new Integer(94));
	literals.put(new ANTLRHashString("desc", this), new Integer(53));
	literals.put(new ANTLRHashString("\u6c42\u548c", this), new Integer(101));
	literals.put(new ANTLRHashString("max", this), new Integer(104));
	literals.put(new ANTLRHashString("sum", this), new Integer(100));
	...
	literals.put(new ANTLRHashString("right", this), new Integer(82));
	literals.put(new ANTLRHashString("\u5b58\u5728\u4e8e", this), new Integer(97));
	...
	literals.put(new ANTLRHashString("str", this), new Integer(98));
	literals.put(new ANTLRHashString("group", this), new Integer(31));
	literals.put(new ANTLRHashString("\u5b58\u5728", this), new Integer(133));
	literals.put(new ANTLRHashString("\u53bb\u6389\u5de6\u7a7a\u683c", this), new Integer(85));
}
